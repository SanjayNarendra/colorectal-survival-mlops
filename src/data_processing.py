...
class DataProcessing:
    ...
    def preprocess_data(self):
        try:
            ...
            raise CustomException("Failed to encode data")
    ...
    def feature_selection(self):
        try:
            ...
            raise CustomException("Failed to select best features")
    ...
    def save_data_and_scaler(self, X_train, X_test, y_train, y_test):
        try:
            ...
            logger.info("Save pkl files complete")
        
        except Exception as e:
            logger.error(f"Error while saving pkl files {e}")
    ...
    def run(self):
        ...
        logger.info("Data Processing pipline executed successfully")
